        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="row m-t-50">
                    {!! Form::open(['route' => ['agrocont.lots.update'], 'method' => 'post']) !!}
                    <div class="col-xs-12 col-sm-9 col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group {{ $errors->has("slope") ? ' has-error' : '' }}'">
                                @php $oldSlope= $lot->slope ?? ''@endphp
                                <label class="control-label">{{trans('agrocont::lots.form.slope')}}</label>
                                <input id="slope" type="number" value="{{old('slope',$oldSlope)}}" name="slope">
                            ...
                            <div class="form-group {{ $errors->has("texture") ? ' has-error' : '' }}'">
                                ...
                                @php
                                    if(isset($performer->texture)){
                    $oldCTexture = array();
                        foreach ($performer->types as $text){
                                   array_push($oldCTexture,$text->id);
                               }
                           }else{
                           $oldCTexture=old('texture');
                           }
                                @endphp
                                ...
                                <select class="select2 form-control select2-multiple" name="texture" id="texture"
                                    ...
                                    <option value="1"
                                            @isset($oldCat) @if(in_array(1, $oldCat)) checked="checked" @endif @endisset>
                                        Arenoso
                                    </option>
                                    <option value="2"
                                            @isset($oldCat) @if(in_array(2, $oldCat)) checked="checked" @endif @endisset>
                                        Fanco
                                    </option>
                                    <option value="3"
                                            @isset($oldCat) @if(in_array(3, $oldCat)) checked="checked" @endif @endisset>
                                        Limoso
                                    </option>
                                    <option value="4"
                                            @isset($oldCat) @if(in_array(4, $oldCat)) checked="checked" @endif @endisset>
                                        Arcilloso
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-4">
                        <div class="p-20">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="status" id="statusI"
                                ...
                                <div class="radio">
                                    <input type="radio" name="status" id="statusA"
